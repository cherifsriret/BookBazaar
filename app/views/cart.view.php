                  ...
                  <table class="w-100">
                      ...
                      <?php foreach($cart_books as $cart_book): 
                        ...
                        <tr>
                              <td>
                                <div class="d-flex">
                                        <img src="<?= $cart_book->getBook()->getImage() ?>" alt="" height= 100>
                                
                                    <div class="name-product flex-1">
                                    <?= $cart_book->getBook()->getTitle() ?>
                                        <br><?=$cart_book->getBook()->getIsbn() ?>
                                    </div>
                                    <div class="price">
                                    <?= $cart_book->getBook()->getPrice() ?>€
                                    </div>
                                  </div>
                              </td>
                              <td class="product-count">
                              <input type="number" class="cart-qty form-control" value="<?= $cart_book->getQty() ?>" data-id="<?= $cart_book->getId() ?>">
                              </td>
                              <td>
                                  <button title="Remove" class="px-2 cart-remove btn btn-danger" data-id="<?= $cart_book->getId() ?>">
